...
type SubscribeBytesUpdate struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Update:
	//
	//	*SubscribeBytesUpdate_Data
	//	*SubscribeBytesUpdate_Pong
	Update        isSubscribeBytesUpdate_Update `protobuf_oneof:"update"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SubscribeBytesUpdate) Reset() {
	*x = SubscribeBytesUpdate{}
	mi := &file_streaming_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubscribeBytesUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubscribeBytesUpdate) ProtoMessage() {}

func (x *SubscribeBytesUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubscribeBytesUpdate.ProtoReflect.Descriptor instead.
func (*SubscribeBytesUpdate) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{5}
}

func (x *SubscribeBytesUpdate) GetUpdate() isSubscribeBytesUpdate_Update {
	if x != nil {
		return x.Update
	}
	return nil
...
func (x *SubscribeBytesUpdate) GetData() *StreamBytesResponse {
	if x != nil {
		if x, ok := x.Update.(*SubscribeBytesUpdate_Data); ok {
			return x.Data
		}
	}
	return nil
...
func (x *SubscribeBytesUpdate) GetPong() *Pong {
	if x != nil {
		if x, ok := x.Update.(*SubscribeBytesUpdate_Pong); ok {
			return x.Pong
		}
	}
	return nil
...
type isSubscribeBytesUpdate_Update interface {
	isSubscribeBytesUpdate_Update()
}

type SubscribeBytesUpdate_Data struct {
	Data *StreamBytesResponse `protobuf:"bytes,1,opt,name=data,proto3,oneof"`
}

type SubscribeBytesUpdate_Pong struct {
	Pong *Pong `protobuf:"bytes,2,opt,name=pong,proto3,oneof"`
}

func (*SubscribeBytesUpdate_Data) isSubscribeBytesUpdate_Update() {}

func (*SubscribeBytesUpdate_Pong) isSubscribeBytesUpdate_Update() {}
...
type StreamBytesResponse struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	BlockNumber uint64                 `protobuf:"varint,1,opt,name=block_number,json=blockNumber,proto3" json:"block_number,omitempty"`
	Timestamp   uint64                 `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // Server ingress timestamp
...
func (x *StreamBytesResponse) Reset() {
	*x = StreamBytesResponse{}
	mi := &file_streaming_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StreamBytesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamBytesResponse) ProtoMessage() {}

func (x *StreamBytesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamBytesResponse.ProtoReflect.Descriptor instead.
func (*StreamBytesResponse) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{7}
}

func (x *StreamBytesResponse) GetBlockNumber() uint64 {
	if x != nil {
		return x.BlockNumber
	}
	return 0
...
func (x *StreamBytesResponse) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *StreamBytesResponse) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_streaming_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_streaming_proto_goTypes = []any{
	...
	(*SubscribeBytesUpdate)(nil), // 6: hyperliquid.SubscribeBytesUpdate
	(*StreamResponse)(nil),       // 7: hyperliquid.StreamResponse
	(*StreamBytesResponse)(nil),  // 8: hyperliquid.StreamBytesResponse
	(*Block)(nil),                // 9: hyperliquid.Block
	(*Pong)(nil),                 // 10: hyperliquid.Pong
	(*Timestamp)(nil),            // 11: hyperliquid.Timestamp
	(*PingRequest)(nil),          // 12: hyperliquid.PingRequest
	(*PingResponse)(nil),         // 13: hyperliquid.PingResponse
	nil,                          // 14: hyperliquid.StreamSubscribe.FiltersEntry
}
var file_streaming_proto_depIdxs = []int32{
	...
	14, // 3: hyperliquid.StreamSubscribe.filters:type_name -> hyperliquid.StreamSubscribe.FiltersEntry
	7,  // 4: hyperliquid.SubscribeUpdate.data:type_name -> hyperliquid.StreamResponse
	10, // 5: hyperliquid.SubscribeUpdate.pong:type_name -> hyperliquid.Pong
	8,  // 6: hyperliquid.SubscribeBytesUpdate.data:type_name -> hyperliquid.StreamBytesResponse
	10, // 7: hyperliquid.SubscribeBytesUpdate.pong:type_name -> hyperliquid.Pong
	3,  // 8: hyperliquid.StreamSubscribe.FiltersEntry.value:type_name -> hyperliquid.FilterValues
	1,  // 9: hyperliquid.Streaming.StreamData:input_type -> hyperliquid.SubscribeRequest
	1,  // 10: hyperliquid.Streaming.StreamDataBytes:input_type -> hyperliquid.SubscribeRequest
	12, // 11: hyperliquid.Streaming.Ping:input_type -> hyperliquid.PingRequest
	11, // 12: hyperliquid.BlockStreaming.StreamBlocks:input_type -> hyperliquid.Timestamp
	5,  // 13: hyperliquid.Streaming.StreamData:output_type -> hyperliquid.SubscribeUpdate
	6,  // 14: hyperliquid.Streaming.StreamDataBytes:output_type -> hyperliquid.SubscribeBytesUpdate
	13, // 15: hyperliquid.Streaming.Ping:output_type -> hyperliquid.PingResponse
	9,  // 16: hyperliquid.BlockStreaming.StreamBlocks:output_type -> hyperliquid.Block
...
func file_streaming_proto_init() {
	...
	file_streaming_proto_msgTypes[5].OneofWrappers = []any{
		(*SubscribeBytesUpdate_Data)(nil),
		(*SubscribeBytesUpdate_Pong)(nil),
	}
	type x struct{}
