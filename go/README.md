...
**Trading:**
- [market_order](examples/market_order/) — Place market orders
- [place_order](examples/place_order/) — Place limit orders
- [modify_order](examples/modify_order/) — Modify existing orders
- [cancel_order](examples/cancel_order/) — Cancel orders
- [cancel_by_cloid](examples/cancel_by_cloid/) — Cancel by client order ID
- [cancel_all](examples/cancel_all/) — Cancel all orders
- [close_position](examples/close_position/) — Close positions
...
**TWAP:**
- [twap](examples/twap/) — Time-weighted average price orders

**Leverage & Margin:**
- [leverage](examples/leverage/) — Update leverage
- [isolated_margin](examples/isolated_margin/) — Isolated margin management

**Transfers & Withdrawals:**
- [transfers](examples/transfers/) — USD and spot transfers
- [withdraw](examples/withdraw/) — Withdraw to L1 (Arbitrum)

**Vaults:**
- [vaults](examples/vaults/) — Vault deposits and withdrawals

**Staking:**
- [staking](examples/staking/) — Stake, unstake, and delegate

**Approval:**
- [approve](examples/approve/) — Builder fee approval
- [builder_fee](examples/builder_fee/) — Check approval status

**Market Info:**
- [markets](examples/markets/) — List markets and mid prices
- [open_orders](examples/open_orders/) — Query open orders
- [preflight](examples/preflight/) — Validate orders before sending
...
**Streaming:**
- [stream_trades](examples/stream_trades/) — WebSocket streaming basics
- [stream_grpc](examples/stream_grpc/) — gRPC streaming basics
- [stream_l4_book](examples/stream_l4_book/) — **L4 order book (individual orders) — CRITICAL**
- [stream_l2_book](examples/stream_l2_book/) — L2 order book (gRPC vs WebSocket)
- [stream_orderbook](examples/stream_orderbook/) — L2 vs L4 comparison
- [stream_websocket_all](examples/stream_websocket_all/) — Complete WebSocket reference (20+ types)
