...
**Trading:**
- [market_order.rs](examples/market_order.rs) — Place market orders
- [place_order.rs](examples/place_order.rs) — Place limit orders
- [modify_order.rs](examples/modify_order.rs) — Modify existing orders
- [cancel_order.rs](examples/cancel_order.rs) — Cancel orders
- [cancel_by_cloid.rs](examples/cancel_by_cloid.rs) — Cancel by client order ID
- [cancel_all.rs](examples/cancel_all.rs) — Cancel all orders
- [close_position.rs](examples/close_position.rs) — Close positions
- [fluent_builder.rs](examples/fluent_builder.rs) — Fluent order builder
- [roundtrip.rs](examples/roundtrip.rs) — Buy and sell round trip
- [hip3_order.rs](examples/hip3_order.rs) — HIP-3 DEX orders
- [schedule_cancel.rs](examples/schedule_cancel.rs) — Dead-man's switch / scheduled cancel

**Trigger Orders:**
- [trigger_orders.rs](examples/trigger_orders.rs) — Stop loss and take profit orders

**TWAP:**
- [twap.rs](examples/twap.rs) — Time-weighted average price orders

**Leverage & Margin:**
- [leverage.rs](examples/leverage.rs) — Update leverage
- [isolated_margin.rs](examples/isolated_margin.rs) — Isolated margin management

**Transfers & Withdrawals:**
- [transfers.rs](examples/transfers.rs) — USD and spot transfers
- [withdraw.rs](examples/withdraw.rs) — Withdraw to L1 (Arbitrum)

**Vaults:**
- [vaults.rs](examples/vaults.rs) — Vault deposits and withdrawals

**Staking:**
- [staking.rs](examples/staking.rs) — Stake, unstake, and delegate

**Approval:**
- [approve.rs](examples/approve.rs) — Builder fee approval
- [builder_fee.rs](examples/builder_fee.rs) — Check approval status

**Market Info:**
- [markets.rs](examples/markets.rs) — List markets and mid prices
- [open_orders.rs](examples/open_orders.rs) — Query open orders
- [preflight.rs](examples/preflight.rs) — Validate orders before sending

**Data APIs:**
- [info_market_data.rs](examples/info_market_data.rs) — Market data and order book
- [info_user_data.rs](examples/info_user_data.rs) — User positions and orders
- [info_candles.rs](examples/info_candles.rs) — Candlestick data
- [info_vaults.rs](examples/info_vaults.rs) — Vault information
- [info_batch_queries.rs](examples/info_batch_queries.rs) — Batch queries
- [hypercore_blocks.rs](examples/hypercore_blocks.rs) — Block and trade data
- [evm_basics.rs](examples/evm_basics.rs) — EVM chain interaction

**Streaming:**
- [stream_trades.rs](examples/stream_trades.rs) — WebSocket streaming basics
- [stream_grpc.rs](examples/stream_grpc.rs) — gRPC streaming basics
- [stream_l4_book.rs](examples/stream_l4_book.rs) — **L4 order book (individual orders) — CRITICAL**
- [stream_l2_book.rs](examples/stream_l2_book.rs) — L2 order book (gRPC vs WebSocket)
- [stream_orderbook.rs](examples/stream_orderbook.rs) — L2 vs L4 comparison
- [stream_websocket_all.rs](examples/stream_websocket_all.rs) — Complete WebSocket reference (20+ types)
